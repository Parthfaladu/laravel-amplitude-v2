...
class AmplitudeService
{
     ...
     *
     * @var \Faladu\Amplitude\Services\Event
     */
    protected $event;
     ...
     *
     * @var \Faladu\Amplitude\Services\Amplitude[]
     */
     ...
     * @return \Faladu\Amplitude\Services\Amplitude
     */
     ...
     *
     * @param null|array|\Faladu\Amplitude\Services\Event Can pass in an event to set as the next event to run, or array to set
     *   properties on that event
     * @return \Faladu\Amplitude\Services\Event
     */
    public function event($event = null)
    {
        if (!empty($event) && $event instanceof \Faladu\Amplitude\Services\Event) {
            $this->event = $event;
     ...
     *
     * @return void
     * @throws \Exception If event or api key not set
     */
